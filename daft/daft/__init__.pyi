...
class WindowSpec:
    @staticmethod
    def from_user_defined_spec(
        partition_by: list[PyExpr],
        order_by: list[PyExpr],
...
class PyExpr:
    ...
    def dense_rank(self) -> PyExpr: ...
    def cume_dist(self) -> PyExpr: ...
    def row_number(self) -> PyExpr: ...
    def percent_rank(self) -> PyExpr: ...
    def lead(self, offset: PyExpr, default: PyExpr) -> PyExpr: ...
    def lag(self, offset: PyExpr, default: PyExpr) -> PyExpr: ...
    def first(self) -> PyExpr: ...
    def last(self) -> PyExpr: ...
    def nth(self, nth: PyExpr) -> PyExpr: ...
...
class PyMicroPartition:
    ...
    def partitioned_window(
        self, window_spec: WindowSpec, window_fns: list[PyExpr], window_names: list[str]
    ) -> PyMicroPartition: ...
    def hash_join(
        self,
